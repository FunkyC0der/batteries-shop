      ...
      <div className="grid gap-6 rounded-3xl border border-border bg-primary p-6 text-primary-foreground sm:p-8 lg:grid-cols-[1.2fr_1fr] lg:items-center">
        <div>
          ...
          <h2 className="mt-3 text-2xl font-semibold tracking-tight sm:text-3xl">
            Потрібен товар, сервіс або енергетичне рішення?
          </h2>
          <p className="mt-3 max-w-2xl text-sm leading-6 opacity-90">
            Надішліть модель приладу, фото обладнання або коротко опишіть
            завдання. Допоможемо з батарейками й лічильниками або сплануємо
            аудит, проєктування, монтаж і сервіс енергетичної системи.
          </p>
        </div>
