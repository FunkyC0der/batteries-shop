...
- [ ] **Реквізити продавця** (ФОП/юрособа: назва, ЄДРПОУ/ІПН, адреса).
      ...
      (`siteConfig.seller.{name,taxId,address}`). `name` вже реальний (ФОП
      Красоченко Єгор Юрійович, за YouControl); `taxId` (РНОКПП/ІПН) і точна
      адреса не публічні — замінити заглушки на реальні дані з витягу ЄДР
